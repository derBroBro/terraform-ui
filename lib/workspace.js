...
var terraform = require('./terraform.js');
...
var mod_exports = {
  ...
  clear: function(id){
    ...
    return new Promise(function(resolve, reject) {
      fs.remove(workspace_dir+id+'\\workspace',function(err){
        if(err){
          reject(err);
        } else {
          resolve();
  ...
  init_dir: function(id) {
    ...
    return new Promise(function(resolve) {
      fs.stat(workspace_dir + id+'\\workspace', function(err, data) {
        if (data === undefined) {
          fs.mkdir(workspace_dir + id+'\\workspace', function() {
            resolve(id);
          });
        } else {
          resolve(id);
